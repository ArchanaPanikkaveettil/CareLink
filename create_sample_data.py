...
def create_sample_caretakers():
    ...
    caretaker1_profile = CaretakerProfile.objects.create(
        ...
        experience_years=8,
        about="Experienced nurse specializing in elderly care. Compassionate and dedicated to providing quality care to senior citizens.",
    ...
    # Experience and services are handled in the about field for simplicity
    ...
    caretaker2_profile = CaretakerProfile.objects.create(
        ...
        experience_years=12,
        about="Physiotherapist turned caretaker with extensive experience in rehabilitation and elderly mobility care. Strong and patient.",
    ...
    # Add experience for caretaker 2
    exp2 = Experience.objects.create(
        caretaker=caretaker2_profile,
        employer="Trivandrum Rehabilitation Center",
        position="Physiotherapy Assistant",
        start_date="2012-01-01",
        end_date="2024-06-30",
        description="Specialized in elderly rehabilitation, post-stroke care, and mobility training",
    )

    # Add services for caretaker 2
    services2 = [
        "physiotherapy",
        "mobility_assistance",
        "personal_care",
    ...
    for service_name in services2:
        service = Service.objects.create(
            caretaker=caretaker2_profile,
            service_type=service_name,
            description=f'Professional {service_name.replace("_", " ").title()}',
        )

    # Add availability for caretaker 2
    ...
    print(
        f"✅ Created caretaker 2: {caretaker2_user.get_full_name()} - Thiruvananthapuram, Kerala"
    )
